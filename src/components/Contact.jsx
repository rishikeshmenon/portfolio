        ...
        >
          ...
          <div className="mt-8 border-t border-white/10 pt-6">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
              ...
              <div className="flex items-center gap-4 text-text-secondary flex-wrap md:flex-nowrap">
                <a
                  href="https://www.linkedin.com/in/rishikesh-menon"
                  target="_blank"
                  rel="noreferrer"
                  className="link-underline font-mono text-sm flex flex-col items-center gap-1"
                >
